 ...
 */
AuthorSchema.statics.getAuthorCount = async function (
 ...
 */
AuthorSchema.statics.getAllAuthors = async function (sortOpts?: {
  [key: string]: 1 | -1;
}): Promise<string[]> {
 ...
 */
AuthorSchema.statics.getAuthorIdByName = async function (
  family_name: string,
  first_name: string
): Promise<mongoose.Types.ObjectId | null> {
